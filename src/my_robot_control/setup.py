...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_wallfollowerv2_exec = my_robot_control.my_robot_wallfollowerv2:main',
            'my_robot_wallfollower_holonomic_exec = my_robot_control.my_robot_wallfollower_holonomic:main',
            'my_robot_wallfollower_holonomicv2_exec = my_robot_control.my_robot_wallfollower_holonomicv2:main',
            'my_robot_wallfollower_holonomicv22_exec = my_robot_control.my_robot_wallfollower_holonomicv22:main',
